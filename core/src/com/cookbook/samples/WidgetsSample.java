...
public class WidgetsSample extends GdxSample {
	...
	private Texture logo, actor, accept, checkBoxOn, checkBoxOff, tfSelection, tfBackground, tfCursor, scroll_horizontal, knob_scroll, plus, minus, touchpad_background, touchpad_knob, dialog_background, caveman, divider, progress_bar, knob_progress_bar, slider_background, slider_knob;
	...
	public void create() {
		...
		label = new Label("This is a label", labelStyle);
		...
		//region Button with background and text
		...
		//region Button with background and icon
		...
		//region Button with background, text and icon
		...
		//region Grouped checkbox buttons
		...
		//region Single line of text input for passwords
		...
		Label label1 = new Label("Stack Label", labelStyle);
...
//		list2.pack();
		...
		Label node1 = new Label("Root-node", labelStyle);
		Label node2 = new Label("Child-node1", labelStyle);
		Label node3 = new Label("Child-node2", labelStyle);
		...
		//region Dialog
		Label message = new Label("Dialog: Exit?", labelStyle);
		...
		WindowStyle ws2 = new WindowStyle();
		ws2.titleFont = font;
		...
		SplitPaneStyle splitPaneS = new SplitPaneStyle();
		...
		Label gameTitle = new Label("WindowLabel", labelStyle);
